 ...
 */
var VirtualGrid = function (_React$PureComponent) {
  _inherits(VirtualGrid, _React$PureComponent);

  function VirtualGrid(props) {
    _classCallCheck(this, VirtualGrid);

    var _this = _possibleConstructorReturn(this, (VirtualGrid.__proto__ || Object.getPrototypeOf(VirtualGrid)).call(this, props));

    _this._onVirtualGridRenderedMemoizer = (0, _createCallbackMemoizer2.default)();
  ...
  _createClass(VirtualGrid, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      if (nextProps.columnCount === 0 && prevState.scrollLeft !== 0 || nextProps.rowCount === 0 && prevState.scrollTop !== 0) {
        ...
        _extends(newState, VirtualGrid._getScrollToPositionStateUpdate({
          prevState: prevState,
